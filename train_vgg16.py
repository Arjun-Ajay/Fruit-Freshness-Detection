...
def main():
    ...
    # Initialize VGG16
    # ---------------------------------
    print("Loading Custom VGG16 Architecture...")
    ...
    # Training Settings
    # ---------------------------------
    epochs = 55 # Matches 50 ssl_pretrain + 5 finetune
    best_val_acc = 0.0
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy > best_val_acc:
            ...
            print(f"⭐ New Personal Best! Model saved as 'vgg16_model.pth' with {val_accuracy:.2f}% accuracy.")
