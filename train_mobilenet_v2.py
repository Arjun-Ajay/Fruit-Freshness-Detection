...
from models.mobilenet_v2 import MobileNetV2_Model
...
def main():
    ...
    # ---------------------------------
    print("Loading Custom MobileNetV2 Architecture...")
    model = MobileNetV2_Model(num_classes=2)
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy > best_val_acc:
            ...
            print(f"⭐ New Personal Best! Model saved as 'mobilenet_v2_model.pth' with {val_accuracy:.2f}% accuracy.")
